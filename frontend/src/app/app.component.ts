...
@Component({
    ...
    imports: [FormsModule, ReactiveFormsModule,Card1Component,Cancel1Component,CommonModule,RouterOutlet,BookingComponent,MainhomepageComponent,BurgerComponent,HomeAComponent,TestbodyComponent,FooterComponent ,BodyComponent,LoginpageComponent,TopnavbarComponent,HttpClientModule,SecondnavbarComponent ]
})
